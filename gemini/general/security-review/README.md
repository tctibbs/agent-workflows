...
This directory contains templates and examples for implementing an automated security review system that provides comprehensive vulnerability scanning and security analysis on code changes. This workflow enables teams to proactively identify and address security issues before they reach production.

## Concept

This workflow establishes a comprehensive methodology for automated security reviews in Gemini to detect vulnerabilities and enforce security best practices:
...
### Templates & Examples
- [Security Review Slash Command](./commands/security-review.toml) - Default security review command.
