...
- [Design Review Agent](./agents/design-review.md) - Agent configuration for automated design reviews
- [CLAUDE.md Snippet](./CLAUDE-SNIPPET.md) - CLAUDE.md configuration snippet for design review integration
- [Slash Command](./commands/design-review.md) - Custom slash command implementation for on-demand design reviews
